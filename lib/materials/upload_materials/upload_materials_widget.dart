...
import 'upload_materials_model.dart';
export 'upload_materials_model.dart';

class UploadMaterialsWidget extends StatefulWidget {
  const UploadMaterialsWidget({super.key});

  static String routeName = 'uploadMaterials';
  static String routePath = '/uploadMaterials';

  @override
  State<UploadMaterialsWidget> createState() => _UploadMaterialsWidgetState();
}

class _UploadMaterialsWidgetState extends State<UploadMaterialsWidget> {
  late UploadMaterialsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadMaterialsModel());

    _model.recurseTextController ??= TextEditingController();
    _model.recurseFocusNode ??= FocusNode();
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed(MaterialesWidget.routeName);
                        },
                        child: Icon(
                          Icons.close_rounded,
                  ...
                  StreamBuilder<List<CareerRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<CareerRecord> containerCareerRecordList =
                          snapshot.data!;
                      ...
                      return Container(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          onChanged: (val) async {
                            ...
                            _model.careerRef = containerCareerRecordList
                                .where((e) => e.name == _model.careerValue)
                                .toList()
                                .firstOrNull
                                ?.reference;
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(),
                    child: TextFormField(
                      controller: _model.recurseTextController,
                      focusNode: _model.recurseFocusNode,
                      autofocus: true,
                      obscureText: false,
                      ...
                      validator: _model.recurseTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                  Text(
