      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Padding(
            ...
            child: StreamBuilder<List<SemesterRecord>>(
              stream: querySemesterRecord(
                singleRecord: true,
              ),
              builder: (context, snapshot) {
                ...
                List<SemesterRecord> columnSemesterRecordList = snapshot.data!;
                // Return an empty Container when the item does not exist.
                if (snapshot.data!.isEmpty) {
                  return Container();
                }
                final columnSemesterRecord = columnSemesterRecordList.isNotEmpty
                    ? columnSemesterRecordList.first
                    : null;
                        ...
                        child: Column(
                          ...
                          children: [
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              text:
                                                  '\nExplora los mejores materiales de ',
                                              style: TextStyle(),
                                            ),
                                            TextSpan(
                                              text: valueOrDefault<String>(
                                            ...
                                            TextSpan(
                                              text:
                                                  '\nen el repositorio colaborativo de ....',
                                              style: TextStyle(),
                                            )
                                          ],
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(UploadMaterialsWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                height: 100.0,
                                decoration: BoxDecoration(
                                  color: Color(0x5900D586),
                        ...
                        child: StreamBuilder<List<CoursesRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Column(
                              ...
                              children:
                                  List.generate(columnCoursesRecordList.length,
                                      (columnIndex) {
                                final columnCoursesRecord =
                                    columnCoursesRecordList[columnIndex];
                                return Visibility(
                                  visible: valueOrDefault(
                                          currentUserDocument?.semester, 0) ==
                                      columnSemesterRecord?.cycle,
