          ...
          child: Padding(
            ...
            child: StreamBuilder<List<CareerRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<CareerRecord> columnCareerRecordList = snapshot.data!;
                // Return an empty Container when the item does not exist.
                if (snapshot.data!.isEmpty) {
                  return Container();
                }
                final columnCareerRecord = columnCareerRecordList.isNotEmpty
                    ? columnCareerRecordList.first
                    : null;
                          ...
                          Row(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      UploadMaterialsWidget.routeName);
                                },
                                child: Container(
                        ...
                        child: Padding(
                          ...
                          child: StreamBuilder<List<CareerRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CareerRecord> searchCCareerRecordList =
                                  snapshot.data!;

                              return FlutterFlowDropDown<String>(
                                controller: _model.searchCValueController ??=
                                    FormFieldController<String>(null),
                                options: searchCCareerRecordList
                                    ...
                                    .toList(),
                                onChanged: (val) async {
                                  safeSetState(() => _model.searchCValue = val);
                                  safeSetState(() {});
                                },
                                width: 200.0,
                                height: 40.0,
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          networkPath:
                                                                              columnCoursesRecord.documentPDF,
                                                                          horizontalScroll:
                                                                              false,
                                                                        ),
                                                                      ),
