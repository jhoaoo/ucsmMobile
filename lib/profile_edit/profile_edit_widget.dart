...
class _ProfileEditWidgetState extends State<ProfileEditWidget> {
  ...
  void initState() {
    ...
    _model.carrierTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.carreer, ''));
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            children: [
                                    ...
                                    await Navigator.push(
                                      ...
                                      PageTransition(
                                        ...
                                        child: FlutterFlowExpandedImageView(
                                          image: Image.memory(
                                            _model.uploadedLocalFile_uploadDataN2xlocal
                                                    .bytes ??
                                                Uint8List.fromList([]),
                                            fit: BoxFit.contain,
                                            errorBuilder:
                              ...
                              Align(
                                alignment: AlignmentDirectional(0.5, -1.24),
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 16.0, 0.0, 0.0),
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (selectedMedia != null &&
                                        ...
                                        safeSetState(() => _model
                                                .isDataUploading_uploadDataN2xlocal =
                                            true);
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadDataN2xlocal =
                                              false;
                                        }
                      ...
                      children: [
                        Expanded(
                          child: Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => TextFormField(
                                controller: _model.carrierTextController,
                                focusNode: _model.carrierFocusNode,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Carrera',
                                  labelStyle: FlutterFlowTheme.of(context)
                                ...
                                validator: _model.carrierTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                          ...
                          child: Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => TextFormField(
                                ...
                                validator: _model
                                    .semesterTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
              ...
              FFButtonWidget(
                onPressed: () async {
                  if (_model.uploadedLocalFile_uploadDataN2xlocal != null &&
                      (_model.uploadedLocalFile_uploadDataN2xlocal.bytes
                              ?.isNotEmpty ??
                          false)) {
                    {
                      safeSetState(() =>
                          _model.isDataUploading_uploadDataJ32firebase = true);
                      var selectedUploadedFiles = <FFUploadedFile>[];
                      var selectedMedia = <SelectedFile>[];
                      var downloadUrls = <String>[];
                      try {
                        selectedUploadedFiles = _model
                                .uploadedLocalFile_uploadDataN2xlocal
                                .bytes!
                                .isNotEmpty
                            ? [_model.uploadedLocalFile_uploadDataN2xlocal]
                            : <FFUploadedFile>[];
                        ...
                        _model.isDataUploading_uploadDataJ32firebase = false;
                      }
                      if (selectedUploadedFiles.length ==
                              selectedMedia.length &&
                          downloadUrls.length == selectedMedia.length) {
                        safeSetState(() {
                          _model.uploadedLocalFile_uploadDataJ32firebase =
                              selectedUploadedFiles.first;
                          _model.uploadedFileUrl_uploadDataJ32firebase =
                              downloadUrls.first;
                        });
                      } else {
                        safeSetState(() {});
