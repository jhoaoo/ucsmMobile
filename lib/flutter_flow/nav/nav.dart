...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: CardRestaurantWidget.routePath,
          builder: (context, params) => CardRestaurantWidget(),
        ),
        FFRoute(
          name: AddMenuWidget.routeName,
          path: AddMenuWidget.routePath,
          builder: (context, params) => AddMenuWidget(),
        ),
        FFRoute(
          name: CreateRestaurantWidget.routeName,
          path: CreateRestaurantWidget.routePath,
