...
import 'reclamos_model.dart';
export 'reclamos_model.dart';

class ReclamosWidget extends StatefulWidget {
  const ReclamosWidget({super.key});

  static String routeName = 'reclamos';
  static String routePath = '/reclamos';

  @override
  State<ReclamosWidget> createState() => _ReclamosWidgetState();
}

class _ReclamosWidgetState extends State<ReclamosWidget> {
  late ReclamosModel _model;
...
<<<<<<< HEAD
                                                return MouseRegionWidget(
                                                  ...
                                                  parameter1: containerVarItem
                                                      .categoryReport,
                                                  parameter2: _model.isEvent,
                                                  updateAction:
                                                      (selectedCategoryC) async {
                                                    _model.selectCategory =
                                                        selectedCategoryC;
...
<<<<<<< HEAD
                                      if (valueOrDefault<bool>(
                                        ...
                                        TextFormField(
                                          controller:
                                              _model.selectTextController,
                                          focusNode: _model.selectFocusNode,
                                          autofocus: false,
                                          enabled: true,
                                          obscureText: false,
